...
- **UNVERIFIED:** no live end-to-end run has been observed yet — the OAuth consent, the resulting Pax response to a real human mention, the reconnect path, and disconnect have not been exercised.
