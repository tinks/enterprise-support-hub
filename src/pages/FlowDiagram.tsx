    ...
    },
    {
      ...
      data: {
        ...
        details: [
          ...
          "Verified 3 Sep 2026 (full rescan): 2,026 messages scanned, 1,049 announcements parsed, 964 skipped, 1,049 upserted, 0 errors → 1,008 closed / 10 live / 6 post-incident / 25 unknown. The 25 unknown are all Jan–Feb 2025 (earliest card format, no status signal) and are left honestly unknown. NOT DONE: the 5-min pg_cron job is NOT scheduled — cron here is authored by hand in the SQL editor — so the feed is static at the backfill until Matt schedules it.",
        ],
        accent: "default",
      },
    },
