    ...
    },
    {
      ...
      data: {
        ...
        details: [
          ...
          "UI: admin-only AccessCard on Admin → Users (/users, src/pages/Users.tsx, nav entry adminOnly) above RolesCard; the page itself renders an 'Admin access required' card for non-admins. Moved off Settings 17 Aug 2026 — Settings keeps only a pointer card. Controls: add-to-roster input, Provision, Unblock, and 'Remove access' behind an AlertDialog confirm. DRIFT IS SHOWN, NOT HIDDEN: an auth account with no roster row renders as 'untracked', and an active row whose account no longer exists renders as 'no backend account'.",
