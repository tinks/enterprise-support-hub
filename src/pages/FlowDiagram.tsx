...
"Listens for assignment webhook topics: conversation.admin.assigned, conversation.admin.open.assigned, ticket.admin.assigned, ticket.team.assigned",
    ...
    },
    {
      ...
      data: {
        ...
        icon: Users,
        details: [
          "Resolver order (first match wins): override → slack_channel (mapped, non-internal) → domain (v3_customer_accounts.domains, excluding lovable.dev + v3_personal_email_domains) → workspace_id (v3_workspace_customer_map, medium confidence) → 'unattributed'.",
          "LOCKSTEP: SQL public.v3_derive_customer + BEFORE trigger intercom_tickets_v3_apply_customer + propagate triggers on v3_customer_accounts / v3_channel_account_map / v3_internal_channels / v3_workspace_customer_map + Deno _shared/v3-customer.ts. Editing rules requires updating all of them.",
