  ...
  return [
    ...
    },
    {
      ...
      data: {
        ...
        details: [
119:           "Modal opened first (time-sensitive trigger_id)",
120:           "Prompt message deleted in background via waitUntil",
121:           "Modal: Email + Project Link fields",
122:           "On submit → creates Intercom ticket",
123:         ],
