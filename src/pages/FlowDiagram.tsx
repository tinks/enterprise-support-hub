    ...
    },
    {
      ...
      data: {
        ...
        details: [
          ...
          "PAUSED in the UI (9 Sep 2026): Pax only answers verified human lovable.dev Slack members and rejected the Ask Lovable app identity. PAX_DISABLED = true in PaxInvestigateControl disables the request and Retry actions and shows the reason inline; the control stays visible so the concept is demonstrable. Backend, schema and audit logging are unchanged and still deployed. Unblocking needs a dedicated automation Slack member (verified @lovable.dev email, scoped to #pax-ets-help, minimum posting scopes) — not a shared personal identity.",
        ],
        accent: "blue",
      },
    },
