    ...
    },
    {
      ...
      data: {
        ...
        details: [
          ...
          "REVIEW PANEL (23 Sep 2026): the ticket sheet's Investigation card now runs 'Escalate to Dev (review, then ask Pax)' → extract-human-info → HumanInfoReviewPanel inline. Editable summary / customer statement (visible 'Review for sensitive info' reminder) / IDs with one-click candidate pills / expected-observed / evidence / steps; impact badge beside the customer's urgency quote. Every field carries its 🟢/🟡/🔴 provenance tag into the posted text.",
