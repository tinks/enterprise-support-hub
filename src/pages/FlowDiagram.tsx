      ...
      data: {
        ...
        details: [
          ...
          "Stats page shows Gmail resolved/open counts and median/avg resolution time — both are deduplicated by subject (same thread = 1 count), matching the 'Email total' dedup logic",
           ...
           "Auto-Intercom lookup: when a Gmail thread detail page loads without an intercom_conversation_id, the system searches Intercom by sender email and shows matching conversations — user can link with one click, syncs to sibling threads",
