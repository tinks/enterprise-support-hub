 ...
 *
 * Reads LOVABLE_API_KEY and handles per-user lovack_* connection keys.
 * Never import this from browser code and never return a connection key or a
...
/** A 401 whose body type starts with "credential_" means re-authorization. */
